    ...
    private Handler handler=new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                alarmIntent = new Intent(BootReceiverJob.this, BootReceiverNC.class);
            }else {
                alarmIntent = new Intent(BootReceiverJob.this, BootReceiverNN.class);
            }
            PendingIntent pendingIntent = PendingIntent.getBroadcast(BootReceiverJob.this, 0, alarmIntent, 0);
